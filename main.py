...
def decrypt_notes():
    ...
    if len(message_encrypted) == 0 or len(master_secret) == 0:
        messagebox.showerror(title="Error!", message="Please enter true")
    else:
        try:
...
input_text = Text(width=20,height=20)
input_text.pack()

master_secret_label = Label(text="Enter master secret", font=FONT)
